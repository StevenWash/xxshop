...
CREATE TABLE `shop_address` (
  ...
  CONSTRAINT `FK_SHOP_ADD_REFERENCE_SHOP_USE` FOREIGN KEY (`userid`) REFERENCES `shop_user` (`ID`)
...
-- ----------------------------
BEGIN;
INSERT INTO `shop_category` VALUES ('05dca3df8e2148b9b40614ffba993fe4', '数码相机', '7'), ('11f141d175ba4d588dac3ebe703662ce', '键盘鼠标', '9'), ('1d3c3584d6164047acd4cff929a9eeef', '手机', '10'), ('3abc475d0745493c883388798717e50e', '台式机', '8'), ('4cff6d6c6c434659bf192b8dbd3814df', '笔记本电脑', '8'), ('df0d1b6ea4014d4f8ee6d823f0db9ee7', '平板电脑', '10'), ('fd06a9d05edb4590ae54b10cfd3b791d', '移动硬盘', '0'), ('huhduisa', '手表', '1');
COMMIT;
...
CREATE TABLE `shop_goods` (
  ...
  `role` int(11) DEFAULT NULL COMMENT '表示商品的热卖程度，值越大，显示越靠前 ',
  `selltime` int(11) NOT NULL COMMENT '表示商品的新度，值越大，表示是最新的推出商品',
  `sellnum` int(11) DEFAULT NULL COMMENT '商品的销量',
  `score` float DEFAULT NULL COMMENT '用户的评分',
  PRIMARY KEY (`id`),
  KEY `FK_SHOP_GOO_REFERENCE_SHOP_CAT` (`categoryid`),
  CONSTRAINT `FK_SHOP_GOO_REFERENCE_SHOP_CAT` FOREIGN KEY (`categoryid`) REFERENCES `shop_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `shop_order` (
  ...
  CONSTRAINT `FK_SHOP_ORD_REFERENCE_SHOP_ADD` FOREIGN KEY (`addressid`) REFERENCES `shop_address` (`id`),
  CONSTRAINT `FK_SHOP_ORD_REFERENCE_SHOP_USE` FOREIGN KEY (`userid`) REFERENCES `shop_user` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `shop_order` VALUES ('0902753763e2482e80de9bf6112c4907', 'f23ef84ff50e467b84ce8ed9cc81c84e', '2016-06-15', '预存款支付', null, null, null, 'c5b343173cc545ef909ac6e0a49de2f4', '176', '快递', '任意', '1'), ('0a42e71dad1745f99f950ec322954819', '1de124d43e8b4d2b9f388087f9766e36', '2016-12-08', '预存款支付', null, null, null, '14a16cd98f4d4b879272d32937f08409', '3699', '快递', '任意', '1'), ('4e7fe10248d545c09a603037c5e72ce4', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2017-03-16', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '3699', '快递', '任意', '1'), ('4f054ca9935f42fd9f4d5a3fe428a16c', '15bbe9543c474f119c6d00ed27fad6fe', '2018-01-06', '预存款支付', null, null, null, 'e82f7add1e2d47a3b2e32d36cf888777', '3699', '快递', '任意', '1'), ('76a8e05abcf84260a94a95cd843ed1ef', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2016-01-09', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '3598', '快递', '任意', '1'), ('78bb2f4883ee4f5e81dd872701e1aa03', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2016-03-15', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '9598', '快递', '任意', '1'), ('952241650b644d0a8ec0073bd5f37960', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2016-01-09', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '1799', '快递', '任意', '1'), ('a0e501c216f942e48906125ba26ab54c', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2016-03-15', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '9598', '快递', '任意', '1'), ('a17d407f3f414a499ba63ca0e958b17d', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2016-01-10', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '1299', '快递', '任意', '1'), ('bb7530503f194ba494ad13abcfc6c4c3', 'f23ef84ff50e467b84ce8ed9cc81c84e', '2016-05-26', '预存款支付', null, null, null, null, '3699', '快递', '任意', '1'), ('eaeed4ee12e548d78f39544d0383b71d', 'f23ef84ff50e467b84ce8ed9cc81c83e', '2016-01-07', '预存款支付', null, null, null, 'ad9e690c7fa5489aaa3fb28b876f48fa', '1199', '快递', '任意', '1');
COMMIT;
...
CREATE TABLE `shop_orderdetail` (
  ...
  KEY `FK_SHOP_ORD_REFERENCE_SHOP_GOO` (`goodid`),
  CONSTRAINT `FK_SHOP_ORD_REFERENCE_SHOP_GOO` FOREIGN KEY (`goodid`) REFERENCES `shop_goods` (`id`),
  CONSTRAINT `FK_SHOP_ORD_REFERENCE_SHOP_ORD` FOREIGN KEY (`orderid`) REFERENCES `shop_order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `shop_orderdetail` VALUES ('09f3c04e97c142f5b1b7dd13c580c6a4', 'a0e501c216f942e48906125ba26ab54c', '09099d7e183349669e3596462bd8846d', '2', '0', '0', '1'), ('1cfd165906f44b68826df0f61763b8f3', '4f054ca9935f42fd9f4d5a3fe428a16c', '0866079a93de4f99a83660abf3d41ddd', '1', '0', '0', '1'), ('2efb797e9b0644d1844af84f94cf4a3a', '0902753763e2482e80de9bf6112c4907', '04ec26885efc45bd9537711f7db8fabe', '2', '0', '0', '1'), ('6de4995e99ec464c9a7bef14dfa6724f', 'eaeed4ee12e548d78f39544d0383b71d', 'e498a5dac9214556a5f5b611e119ee2f', '1', '0', '0', '1'), ('945dfbdf13344ebf81ef01e6c80c2205', '78bb2f4883ee4f5e81dd872701e1aa03', '09099d7e183349669e3596462bd8846d', '2', '0', '0', '1'), ('a38110c87900443dab2e979234640512', '4e7fe10248d545c09a603037c5e72ce4', '0866079a93de4f99a83660abf3d41ddd', '1', '0', '0', '1'), ('aecdab31253141cd88082ef5df2b720c', 'bb7530503f194ba494ad13abcfc6c4c3', '0866079a93de4f99a83660abf3d41ddd', '1', '0', '0', '1'), ('b0cf1f0c66f24c7b9ec731837409f6fc', 'a17d407f3f414a499ba63ca0e958b17d', 'db9efbd7c28b4c279f0d1f7cc4dd32b1', '1', '0', '0', '1'), ('d32b0f8098c347c194281d3e201d26a7', '952241650b644d0a8ec0073bd5f37960', '22395b73210745a9b6c4d5f4d1d5a12a', '1', '0', '0', '1'), ('d6a697259f6e4b65b6a105bae23ccdc6', '76a8e05abcf84260a94a95cd843ed1ef', '22395b73210745a9b6c4d5f4d1d5a12a', '2', '0', '0', '1'), ('e1bd47d3910c4e6ebea4cb2ee9a0c5a7', '0a42e71dad1745f99f950ec322954819', '0866079a93de4f99a83660abf3d41ddd', '1', '0', '0', '1');
COMMIT;
...
CREATE TABLE `shop_user` (
  ...
  `status` int(11) DEFAULT NULL COMMENT '保存用户状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `shop_user` VALUES ('15bbe9543c474f119c6d00ed27fad6fe', 'huaxin', '123456', '13636036616', '10000', 'useravatars/15bbe9543c474f119c6d00ed27fad6fe.png', '2016-05-13  08:32:33', 'u', '1'), ('1de124d43e8b4d2b9f388087f9766e36', '456', '123456', '18186533315', '6301', 'useravatars/1de124d43e8b4d2b9f388087f9766e36.jpg', '2016-12-08  14:46:37', 'u', '1'), ('9d97fc96d73e4126bfbde468fbf420d6', 'zzzz', '123456', '18186533315', '0', null, '2017-04-09  23:27:05', 'u', '0'), ('f23ef84ff50e467b84ce8ed9cc81c83e', '华鑫', '123456', '18186533315', '91356', 'useravatars/f23ef84ff50e467b84ce8ed9cc81c83e.jpg', '2015-12-21  22:07:49', 'u', '1'), ('f23ef84ff50e467b84ce8ed9cc81c84e', 'admin', 'admin', '18186533315', '99824', 'useravatars/f23ef84ff50e467b84ce8ed9cc81c83e.png', '2015-12-21  22:07:49', 'a', '0');
COMMIT;
