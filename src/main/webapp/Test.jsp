...
<form action="./cart/addCart" method="post">
    <input name="userId" value="yin" />
    <input name="goodsId" value="101" />
...
<%--<form action="./comment/view" method="post">--%>
    ...
    <%--<input type="submit" value="commentView" />--%>
<%--</form>--%>

<%--<form action="./comment/list" method="post">--%>
    <%--<input type="submit" value="commentList" />--%>
<%--</form>--%>

<%--<form action="./order/payTest" method="post">--%>
    <%--<input type="submit" value="payTest" />--%>
<%--</form>--%>
